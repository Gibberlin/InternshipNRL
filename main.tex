...
\textbf{Annexure I — Core Configuration: OT Digital Twin simulation sandbox}
...
\textbf{Annexure II — Logstash Pipeline Configuration: Logstash event processing pipeline}
...
\textbf{Annexure III — Filebeat Collector Manifest: Filebeat security agent configuration}
...
\textbf{Annexure IV — Sample Normalised Ingestion JSON Payloads}
